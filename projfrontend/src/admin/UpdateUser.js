...
const UpdateUser = () => {
	...
	return (
		<Base title="Welcome" description="" className="container bg-info p-4">
			<div>
				...
				{user.role === 0 && (
					<Link to="/user/dashboard" className="btn btn-md btn-warning mb-3">
						User Home
					</Link>
				)}
