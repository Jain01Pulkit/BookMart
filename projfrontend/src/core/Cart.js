...
const Cart = () => {
 ...
 const {user} = isAutheticated();
  ...
  return (
    <Base title=" Welcome To Cart "description=""> 
    <center>
    <img src="https://www.shareicon.net/data/128x128/2015/05/08/35309_ecommerce_400x400.png" alt="Center" />
    </center>
    <div>
...
<Link to={`/cart/shipping/${user._id}`} className="btn btn-lg btn-success mb-3">
