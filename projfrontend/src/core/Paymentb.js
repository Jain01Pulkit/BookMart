			...
			<div className="row">
				<div className="col-md-6 offset-sm-3 text-center">
					...
					>
						...
						<img src="https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/320/google/298/package_1f4e6.png" />
			...
			<div>
				{info.clientToken !== null && products.length > 0 ? (
					<div>
						...
						/>
						<button
							className="btn btn-lg btn-warning ml-1"
							onClick={onPurchase}
						>
							Confirm and Pay
						</button>
